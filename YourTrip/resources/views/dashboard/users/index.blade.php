        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{route('user.akomodasi')}}" class="nav-link">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    Akomodasi
                                </p>
                                                        ...
                                                        <div class="container_12">
                                                            ...
                                                            <div class="grid_4">
                                                                <div class="banner">
                                                                    ...
                                                                    <img src="http://127.0.0.1:8000/template/images/gam/{{ $ht->gambar}}.jpg" alt="">
                                                                    <div class="label">
                                                                        <div class="title" style=" text-shadow: 0 0 4px #001eaa">{{ $ht->nama_hotel}}</div>
                                                                        <div class="price" style=" text-shadow: 0 0 4px #001eaa">MULAI<span>{{ $ht->harga}}</span></div>
                                                                        <a href="">PESAN</a>
                                                                    </div>
