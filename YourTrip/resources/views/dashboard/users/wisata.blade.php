        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{route('user.wisata')}}" class="nav-link active">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    Wisata
                                </p>
            ...
            <div class="content">
                <div class="container_12">
                    <div class="grid_8">
                        ...
                        <div class="block2">
                            <img src="http://127.0.0.1:8000/template/images/{{ $wst->gambar}}.jpg" alt="" class="img_inner fleft">
                            <div class="extra_wrapper">
                                <div class="text1 col1"><a href="">{{ $wst->nama_wisata}}</a></div>
                                <p>{{ $wst->deskripsi}}</p>
                                <br>
                            </div>
                        </div>
